...
\name{Dakota}{Madden-Fong}
\address{3624 Moraga St, San Francisco, CA 94122, USA}
\mobile{(415) 810-0334}

\email{maddenfong@gmail.com}
\homepage{TrifectaIII.github.io}
\github{TrifectaIII}
%\linkedin{posquit0}
%\skype{skypeid}
...
\makecvfooter{\today}{Dakota Madden-Fong~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
